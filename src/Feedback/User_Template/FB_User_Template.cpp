...
//                   --> ParAttInt[PAR_TYPE/PAR_FLAG/etc][ ParSortID[...] ]
=======
//                   --> ParAttInt[PAR_TYPE/PAR_PUID/PAR_FLAG/etc][ ParSortID[...] ]
>>>>>>> main
...
// for a complete example, see src/TestProblem/Hydro/Plummer/FB_Plummer.cpp
   ...
   for (int t=0; t<NPar; t++)
   {
      ...
      const double xyz[3] = { ParAttFlt[PAR_POSX][p], ParAttFlt[PAR_POSY][p], ParAttFlt[PAR_POSZ][p] };
