...
#  ifdef PARTICLE
   ...
   Par_Init_Attribute_User_Ptr       = AddNewParticleAttribute_CF; // set PAR_NATT_USER;               example: TestProblem/Hydro/AGORA_IsolatedGalaxy/Init_TestProb_Hydro_AGORA_IsolatedGalaxy.cpp --> AddNewParticleAttribute()
#  endif
#  ifdef FEEDBACK
