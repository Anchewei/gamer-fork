...
2. This file is shared by both CPU and GPU
   ...
   GPU_EoS_Barotropic.cu -> CPU_EoS_Barotropic.cpp
...
//
// Note        :  1. Invoked by EoS_Init_Barotropic()
...
//-------------------------------------------------------------------------------------------------------
#ifndef __CUDACC__
void EoS_SetAuxArray_Barotropic( double AuxArray_Flt[], int AuxArray_Int[] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensEint2Pres_Barotropic
...
//                2. See EoS_SetAuxArray_Barotropic() for the values stored in AuxArray_Flt/Int[]
//
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Pres_Barotropic( const real Dens, const real Eint, const real Passive[],
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensPres2Eint_Barotropic( const real Dens, const real Pres, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensPres2CSqr_Barotropic
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensPres2CSqr_Barotropic( const real Dens, const real Pres, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Temp_Barotropic( const real Dens, const real Eint, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_DensTemp2Pres_Barotropic
// Description :  Convert gas mass density and temperature to gas pressure
//
// Note        :  1. See EoS_SetAuxArray_Barotropic() for the values stored in AuxArray_Flt/Int[]
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensTemp2Pres_Barotropic( const real Dens, const real Temp, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static real EoS_DensEint2Entr_Barotropic( const real Dens, const real Eint, const real Passive[],
                                             const double AuxArray_Flt[], const int AuxArray_Int[],
                                             const real *const Table[EOS_NTABLE_MAX] )
{
...
//-------------------------------------------------------------------------------------------------------
// Function    :  EoS_General_Barotropic
...
//-------------------------------------------------------------------------------------------------------
GPU_DEVICE_NOINLINE
static void EoS_General_Barotropic( const int Mode, real Out[], const real In_Flt[], const int In_Int[],
                                       const double AuxArray_Flt[], const int AuxArray_Int[],
                                       const real *const Table[EOS_NTABLE_MAX] )
{
...
FUNC_SPACE EoS_DE2P_t EoS_DensEint2Pres_Ptr = EoS_DensEint2Pres_Barotropic;
FUNC_SPACE EoS_DP2E_t EoS_DensPres2Eint_Ptr = EoS_DensPres2Eint_Barotropic;
FUNC_SPACE EoS_DP2C_t EoS_DensPres2CSqr_Ptr = EoS_DensPres2CSqr_Barotropic;
FUNC_SPACE EoS_DE2T_t EoS_DensEint2Temp_Ptr = EoS_DensEint2Temp_Barotropic;
FUNC_SPACE EoS_DT2P_t EoS_DensTemp2Pres_Ptr = EoS_DensTemp2Pres_Barotropic;
FUNC_SPACE EoS_DE2S_t EoS_DensEint2Entr_Ptr = EoS_DensEint2Entr_Barotropic;
FUNC_SPACE EoS_GENE_t EoS_General_Ptr       = EoS_General_Barotropic;

//-----------------------------------------------------------------------------------------
// Function    :  EoS_SetCPU/GPUFunc_Barotropic
...
//
//                      EoS_SetFunc_Barotropic( CPU_FuncPtr, GPU_FuncPtr );
//
//                3. Call-by-reference
//
...
#ifdef __CUDACC__
__host__
void EoS_SetGPUFunc_Barotropic( EoS_DE2P_t &EoS_DensEint2Pres_GPUPtr,
...
void EoS_SetCPUFunc_Barotropic( EoS_DE2P_t &EoS_DensEint2Pres_CPUPtr,
...
void EoS_SetAuxArray_Barotropic( double [], int [] );
void EoS_SetCPUFunc_Barotropic( EoS_DE2P_t &, EoS_DP2E_t &, EoS_DP2C_t &, EoS_DE2T_t &, EoS_DT2P_t &, EoS_DE2S_t &, EoS_GENE_t & );
#ifdef GPU
void EoS_SetGPUFunc_Barotropic( EoS_DE2P_t &, EoS_DP2E_t &, EoS_DP2C_t &, EoS_DE2T_t &, EoS_DT2P_t &, EoS_DE2S_t &, EoS_GENE_t & );
#endif

//-----------------------------------------------------------------------------------------
// Function    :  EoS_Init_Barotropic
...
void EoS_Init_Barotropic()
{
   ...
   EoS_SetAuxArray_Barotropic( EoS_AuxArray_Flt, EoS_AuxArray_Int );
   EoS_SetCPUFunc_Barotropic( EoS_DensEint2Pres_CPUPtr, EoS_DensPres2Eint_CPUPtr,
                                 EoS_DensPres2CSqr_CPUPtr, EoS_DensEint2Temp_CPUPtr,
                                 EoS_DensTemp2Pres_CPUPtr, EoS_DensEint2Entr_CPUPtr,
                                 EoS_General_CPUPtr );
#  ifdef GPU
   EoS_SetGPUFunc_Barotropic( EoS_DensEint2Pres_GPUPtr, EoS_DensPres2Eint_GPUPtr,
